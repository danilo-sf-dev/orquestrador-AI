...
Depois de `APROVAR SPEC/PLANO`, a SPEC fica congelada. Mudança material posterior precisa voltar à fase
...
Esses nomes pertencem ao modelo anterior. Conceitualmente, `03-prd.md` cumpria papel equivalente ou
muito próximo da SPEC atual. Ao consultar uma feature antiga, use seu conteúdo como memória histórica
após revalidação, sem propagar a nomenclatura antiga para uma feature nova.
